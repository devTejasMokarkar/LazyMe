...
import { CheckCircle, XCircle, Lightbulb, TrendingUp, ArrowRight, HelpCircle, Sparkles } from "lucide-react";
...
export function ATSScoreCard({ data, onImprove, onApplyKeyword, applyingKeyword, improving, changes, previousScore, analysis, estimatedScore, onAutoFix, autoFixing }: ATSScoreCardProps) {
